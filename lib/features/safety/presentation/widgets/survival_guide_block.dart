...
import 'package:jolutrip_app/features/safety/presentation/widgets/shared/expandable_card.dart';
...
class _QuestionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(bottom: isLast ? 0 : AppDimens.spaceM),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
          ...
          if (!isLast) const SizedBox(height: AppDimens.spaceM),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(AppDimens.radiusM),
        border: Border.all(
          color: (colors[tip.category] ?? AppColors.primary).withOpacity(0.3),
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
            ...
            height: 36,
            decoration: BoxDecoration(
              color: (colors[tip.category] ?? AppColors.primary).withOpacity(
                0.15,
              ),
